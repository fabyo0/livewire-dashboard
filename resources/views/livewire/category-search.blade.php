<div class="flex flex-col mt-8">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            ...
            <div class="search-style-2 my-4">
                <form>
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.live="categorySearch" type="search" id="default-search"
                               ...
                               placeholder="Search Category, SKU code..." required>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-center mt-5 mb-5">
            @if(isset($query))
                {{ $categories->appends($query)->onEachSide(1)->links() }}
            @else
                {{ $categories->onEachSide(1)->links('vendor.livewire.tailwind') }}
            @endif
        </div>
    </div>
</div>
