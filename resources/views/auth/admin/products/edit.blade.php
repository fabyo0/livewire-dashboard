                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="purchasable"
                                       class="block my-2 text-sm font-medium text-gray-700">Purchasable</label>
                                <div class="mt-4">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="published"
                                       class="block my-2 text-sm font-medium text-gray-700">Published</label>
                                <div class="mt-4">
                        ...
                        <div class="grid grid-cols-6 gap-6 py-3">
                            ...
                            <div class="col-span-4 sm:col-span-3">
                                <label for="Descrizione"
                                       class="block my-2 text-sm font-medium text-gray-700">Short Description</label>
                            ...
                            <div class="col-span-4 sm:col-span-3">
                                <label for="Descrizione"
                                       class="block my-2 text-sm font-medium text-gray-700">Long Description</label>
