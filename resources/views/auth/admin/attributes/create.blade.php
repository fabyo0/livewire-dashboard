...
@section('body')
    ...
    <h3 class="text-gray-700 text-3xl font-medium">Create Attribute</h3>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-4 sm:col-span-4">
                                <label for="parent_id"
                                       class="block text-sm font-medium text-gray-700">Type (leave blank to create main typology)</label>
